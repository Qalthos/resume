...
\section{OPEN SOURCE PROJECTS}
    ...
    \title{infoboard}
    \employer{github.com/FOSSRIT/infoboard}
    \dates{2012 - present}
    ...
    \title{Remysmoke}
    \employer{http://github.com/Qalthos/remysmoke}
    \dates{2011 - present}
    ...
    \employer{http://github.com/FOSSRIT/monroe-elections}
    \dates{2010 - present}
    ...
    \title{GrooveBot}
    \employer{http://github.com/FOSSRIT/groovebot}
    \dates{2010 - present}
    ...
    \title{CIVX}
    \employer{http://github.com/civx/civx}
    \dates{2010 - 2011}
